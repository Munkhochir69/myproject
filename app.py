...
all_questions = {
    ...
    'LV': ['Их биеийн гэмтэл', 'Хэвийн бус дуу чимээ', 'Антифризийн түвшин', 'Аккумлятор ба кабель', 'Хөдөлгүүрийн тосны түвшин', 'Машинаас тос гоожсон эсэхийг шалгах', 'Гар кардан', 'Дуут дохио', 'Шил арчигч', 'Рулийн систем', 'Тормозны систем', 'Хаалга ба цонхнууд', 'Бүх гэрэл дохионууд', 'Суудал суудлын бүс', 'Салхины шил бас толинууд', 'Эмийн сан', 'Галын хор', 'Бичиг баримтууд бүрэн эсэх', 'Машины засвар үйлчилгээнд хэрэглэх багаж', 'Дугуй (элэгдэл ба хий, запас дугуй)'],
    'Drill': ['Хөдөлгүүрийн тос','Гидрийн шингэн', 'Эргүүлэгч толгойн тос', 'Компрессорын тос', 'Редукторын тос', 'Хөргөлтийн шингэн', 'Алхны тос', 'Өтгөн тосолгооны цэгүүд', 'Цамхагын шланк болон зам', 'Кабины хянах самбарууд', 'Станц', 'Цонх болон камер', 'Кабин доторх цэвэрлэгээ', 'Гарын багаж хэрэгсэл', 'Самбар болон конус' ]
}
